...
class TwimlOutApi
{
    ...
    constructor(app)
    {
        ...
        app.get(TwilioUrlDelegate.twimlGenerateCall(), function (req:express.Request, res:express.Response)
        {
            ...
            this.phoneCallDelegate.triggerCall(callId, url, callbackUrl);
            ...
            /* PhoneCallDelegate().get(callId, null, [IncludeFlag.INCLUDE_INTEGRATION_MEMBER_USER])
                .then(
            ...
            var ttt = new ScheduledTaskDelegate().scheduleJobs()
                .then (
