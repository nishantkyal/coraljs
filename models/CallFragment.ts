...
class CallFragment extends BaseModel
{
    ...
    private from_number:number;
    private to_number:number;
    ...
    getFromNumber():number { return this.from_number; }
    getToNumber():number { return this.to_number; }
    ...
    setFromNumber(val:number):void { this.from_number = val; }
    setToNumber(val:number):void { this.to_number = val; }
