...
class CallFragment extends BaseModel
{
    ...
    private agent_call_sid_user:string;
    private agent_call_sid_expert:string;
    ...
    getAgentCallSidUser():string    { return this.agent_call_sid_user; }
    getAgentCallSidExpert():string  { return this.agent_call_sid_expert; }
    ...
    setAgentCallSidUser(val:string):void    { this.agent_call_sid_user = val; }
    setAgentCallSidExpert(val:string):void  { this.agent_call_sid_expert = val; }
