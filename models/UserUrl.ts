...
class UserUrl extends BaseModel
{
    ...
    static PUBLIC_FIELDS:string[] = [UserUrl.COL_ID, UserUrl.COL_USER_ID, UserUrl.COL_LINKEDIN, UserUrl.COL_FACEBOOK, UserUrl.COL_TWITTER, UserUrl.COL_TUMBLR, UserUrl.COL_BLOG, UserUrl.COL_WEBSITE];
