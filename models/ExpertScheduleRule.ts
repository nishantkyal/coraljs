...
///<reference path='../enums/MoneyUnit.ts'/>
...
module models
{
    export class ExpertScheduleRule extends BaseModel
    {
        ...
        repeat_end:number;
        duration:number;
        private price_unit:enums.MoneyUnit;
        ...
        getPriceUnit():enums.MoneyUnit { return this.price_unit; }
        ...
        setPriceUnit(val:enums.MoneyUnit):void { this.price_unit = val; }
