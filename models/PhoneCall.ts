...
module models
{
    export class PhoneCall extends BaseModel
    {
        ...
        isValid():boolean
        {
            return (!common.Utils.isNullOrEmpty(this.getCallerId())
                        && !common.Utils.isNullOrEmpty(this.getExpertId())
                            && !common.Utils.isNullOrEmpty(this.getAgenda())
                                && !common.Utils.isNullOrEmpty(this.getDuration())
                                    && !common.Utils.isNullOrEmpty(this.getScheduleId()));
        }
    }
}