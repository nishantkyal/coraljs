...
exports["Client Mockup"] = {
    "All command": function(test){
        ...
        server.listen(PORT_NUMBER, function(err){
            server.on("connect", function(socket){
                socket.composeAndSend("220 Welcome");
                socket.on("command", function(command, payload){
                    switch(command) {
                        case "HELO": socket.composeAndSend("250 HI"); break;
                        case "NOOP": socket.composeAndSend("250 OK"); break;
                        case "QUIT": socket.composeAndSend("221 Bye"); socket.end(); break;
                        default: socket.composeAndSend("500");
                    }
                });
            ...
            server.on("connect", function(socket){
                ...
                socket.on("command", function(command, payload){
                    switch(command){
                        ...
                        case "NOOP": socket.composeAndSend("250 OK"); break;
                        case "QUIT": socket.composeAndSend("221 Bye"); socket.end(); break;
                        case "STARTTLS": socket.startTLS(); socket.composeAndSend("220 Go ahead"); break;
                        default: socket.composeAndSend("500");
                    }
                });
