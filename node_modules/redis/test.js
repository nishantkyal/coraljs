...
tests.TYPE = function () {
    ...
    client.TEMPLATE(["string key"], require_string("string", name));
    client.TEMPLATE(["list key"], require_string("list", name));
    client.TEMPLATE(["set key"], require_string("set", name));
    client.TEMPLATE(["zset key"], require_string("zset", name));
    client.TEMPLATE("not here yet", require_string("none", name));
    client.TEMPLATE(["hash key"], last(name, require_string("hash", name)));
};
